#ifndef __NEXTGEN_KPM_H
#define __NEXTGEN_KPM_H
...
int nextgen_handle_kpm(unsigned long control_code, unsigned long arg1, unsigned long arg2, unsigned long result_code);
 ...
 */
#define NEXTGEN_KPM_LOAD 1

/*
 * prctl(xxx, 2, "NAME")
 * success return 0, error return -N
 */
#define NEXTGEN_KPM_UNLOAD 2
