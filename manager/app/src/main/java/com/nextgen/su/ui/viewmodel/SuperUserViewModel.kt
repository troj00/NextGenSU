package com.nextgen.su.ui.viewmodel
...
import com.nextgen.su.ui.KsuService
import com.nextgen.su.ui.util.*
...
import com.nextgen.zako.IKsuInterface
...
enum class AppCategory(val displayNameRes: Int, val persistKey: String) {
    ALL(com.nextgen.su.R.string.category_all_apps, "ALL"),
    ROOT(com.nextgen.su.R.string.category_root_apps, "ROOT"),
    CUSTOM(com.nextgen.su.R.string.category_custom_apps, "CUSTOM"),
    DEFAULT(com.nextgen.su.R.string.category_default_apps, "DEFAULT");
...
enum class SortType(val displayNameRes: Int, val persistKey: String) {
    NAME_ASC(com.nextgen.su.R.string.sort_name_asc, "NAME_ASC"),
    NAME_DESC(com.nextgen.su.R.string.sort_name_desc, "NAME_DESC"),
    INSTALL_TIME_NEW(com.nextgen.su.R.string.sort_install_time_new, "INSTALL_TIME_NEW"),
    INSTALL_TIME_OLD(com.nextgen.su.R.string.sort_install_time_old, "INSTALL_TIME_OLD"),
    SIZE_DESC(com.nextgen.su.R.string.sort_size_desc, "SIZE_DESC"),
    SIZE_ASC(com.nextgen.su.R.string.sort_size_asc, "SIZE_ASC"),
    USAGE_FREQ(com.nextgen.su.R.string.sort_usage_freq, "USAGE_FREQ");
