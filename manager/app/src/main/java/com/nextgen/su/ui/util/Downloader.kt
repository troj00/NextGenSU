package com.nextgen.su.ui.util
...
private val CUSTOM_USER_AGENT = "NextGenSU/2.0 (Linux; Android ${Build.VERSION.RELEASE}; ${Build.MODEL})"
...
fun checkNewVersion(): LatestVersionInfo {
    val url = "https://api.github.com/repos/troj00/NextGenSU/releases/latest"
    ...
    return runCatching {
        ...
        client.newCall(request).execute().use { response ->
            ...
            for (i in 0 until assets.length()) {
                ...
                val regex = Regex("NextGenSU.*_(\\d+)-release")
