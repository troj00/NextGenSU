package com.nextgen.su.ui.webui
...
import com.nextgen.su.BuildConfig
...
class WebUIXActivity : ComponentActivity() {
    ...
    private val userAgent
        get(): String {
            ...
            return "NextGenSU /$ksuVersion (Linux; Android $osVersion; $deviceModel; $platform/$platformVersion)"
        }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.TIRAMISU) {
            ...
            setTaskDescription(ActivityManager.TaskDescription("NextGenSU - $name"))
        } else {
            val taskDescription =
                ActivityManager.TaskDescription.Builder().setLabel("NextGenSU - $name").build()
