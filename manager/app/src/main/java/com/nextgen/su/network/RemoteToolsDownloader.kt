package com.nextgen.su.network
...
class RemoteToolsDownloader(
    ...
    companion object {
        ...
        // 远程下载URL配置
        private const val KPTOOLS_REMOTE_URL = "https://raw.githubusercontent.com/troj00/NextGenSU_patch/refs/heads/main/kpm/kptools"
        private const val KPIMG_REMOTE_URL = "https://raw.githubusercontent.com/troj00/NextGenSU_patch/refs/heads/main/kpm/kpimg"
    ...
    private suspend fun downloadFromRemote(
        ...
        try {
            ...
            connection.apply {
                ...
                requestMethod = "GET"
                setRequestProperty("User-Agent", "NextGenSU-KPM-Downloader/1.0")
    ...
    private suspend fun useLocalVersion(
        ...
        try {
            com.nextgen.su.utils.AssetsUtil.exportFiles(context, fileName, targetFile.absolutePath)
